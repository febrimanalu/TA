	...
	if(isset($_POST["Import"])){
		...
		if($_FILES["file"]["size"] > 0)
		{
	        ...
	        while (($emapData = fgetcsv($file, 10000, ",")) !== FALSE)
	        {
	            ...
	            $sql = "INSERT into mesin (`ReqID`, `Malfunction Symptom`, `PIC`, `Create_at`,`CloseDate`, `Defect`, `Actiontype`, `RelatedPart`) values('$emapData[0]','$emapData[1]','$emapData[2]','$emapData[3]','$emapData[4]','$emapData[5]','$emapData[6]','$emapData[7]')";
